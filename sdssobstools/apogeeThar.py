...
# select zone around line  center
  ...
  x10 = int(p0[0][1]-zone) ;   x20 = int(p0[0][1]+zone)

  #x=numpy.arange(data1.shape[1])[x1:x2]  #  x-axis array in pix
  #x=numpy.arange(len(data1[0,:]))[x1:x2]  #  x-axis array in pix
  x=numpy.arange(data1.shape[1])[x10:x20]  #  x-axis array in pix
  spe=data1[fiber,x10:x20]  #read spectrum in the line range 
