...
Completed: 10763, 11324, 7766, 11278, 7744, 7748, 8733, 8746, 8748, 10902, 11316, 
10901, 11317, 7747, 11289, 11046, 11081, 7759, 11288, 8750, 11080, 11086, 10904, 1
1315, 7758, 11285, 7750, 8752, 11318, 7769, 11284
...
def boss_str(plates, mjd1, mjd2, verbose):
    ...
    mjdCompleted=None;  nCompleted=0; nIncompl=0; nExp=0;  
    platesCompl=[];  platesIncompl=[]
    ...
    for plate in sorted(plates.keys()):
        ...
        print("%2s   %5s   %2d    %-10s  %5s   %-5s " % \
               (plates[plate][1], plate, plates[plate][0], donness, mjdCompleted,  plates[plate][3]))  
