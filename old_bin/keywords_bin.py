...
if __name__ == "__main__":
    #parser = optparse.OptionParser()   
    parser.add_option('-a', '--actor', help='Actor to find, default is All',dest='actor',default=None)
    parser.add_option('-k', '--keyword', help='Keyword to find, default is All',dest='keyword',default=None)
    parser.add_option('-r', '--regex', help='regex to search keywords, default is All',dest='reg',default=None)
